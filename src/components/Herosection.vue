      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 d-none d-md-block">
            <img src="../assets/images/img1.svg" class="img-fluid hero__img" alt=""><br>
          </div>
        </div>
      </div>
  </div>
...
.hero{
 ...
 .text{
   h5{
    ...
    letter-spacing: 2px;
    line-height: 1.4;
    text-shadow: 0.03em 0 0.03em #fff;
 ...
 .social__holder{
  ...
  //  width: 50px;
   ...
   padding: 2rem 1rem;
   .fa-facebook-f, .fa-twitter, .fa-whatsapp{
     color: #fff;
     &:hover{
